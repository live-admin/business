...
layui.define(["element","jquery","layer"],function(exports){
    ...
    function Begin_loading(){
        ...
        console.log($.cookie('realname'));
        if($.cookie('access_token')==""||$.cookie('access_token')==null){
            window.location.href="login.html";
        }else{
            $(".userName").html($.cookie('realname'));
    ...
    var navs = [{
        "title" : "应用管理",
        "icon" : "icon-text",
        "href" : "page/news/application.html",
        "spread" : false
    }];
    var single_url;
    ...
    function start(){
        $.ajax({
            ...
            success:function(data){
                if(data.code==0){
                    var list =data.content.app_list;
                    for(var i=0;i<list.length;i++){
                        var array='';
                        if(list[i].is_community==0){
                            array={
                                "title" :list[i].name,
                                "icon" : "&#xe624;",
                                "href" : "",
                                ...
                                "children" : [
                                    {
                                        "title" : "账号管理("+list[i].name+")",
                                        "icon" : "&#xe612;",
                                        "href" : "page/application/newsList.html?app_key="+list[i].app_key,
                                        "spread" : false
                                    },{
                                        "title" : "注册人数统计("+list[i].name+")",
                                        "icon" : "&#xe63c;",
                                        "href" : "page/application/Statistics.html?app_key="+list[i].app_key,
                                        "spread" : false
                                    },{
                                        "title" : "登录人数统计("+list[i].name+")",
                                        "icon" : "&#xe63c;",
                                        "href" : "page/application/login_num.html?app_key="+list[i].app_key,
                                        "spread" : false
                                    },{
                                        "title" : "日志查询("+list[i].name+")",
                                        "icon" : "&#xe637;",
                                        "href" : "page/application/linksList.html?app_key="+list[i].app_key,
                                        "spread" : false
                                    },{
                                        "title" : "数据展示("+list[i].name+")",
                                        "icon" : "&#xe62c;",
                                        "href" : "page/application/linksAdd.html?app_key="+list[i].app_key,
                                        "spread" : false
                                    }
                                ]
                            };
                            ...
                            array={
                                ...
                                "children" : [
                                    ...
                                    // },
                                    {
                                        "title" : "小区登录注册统计("+list[i].name+")",
                                        "icon" : "&#xe62e;",
                                        "href" : "page/application/area.html?app_key="+list[i].app_key,
                                        "spread" : false
                                    },{
                                        "title" : "数据展示("+list[i].name+")",
                                        "icon" : "&#xe62c;",
