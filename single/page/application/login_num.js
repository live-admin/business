layui.config({
    ...
    var psges_all='';
    var on=true;
    start(app_key,page_size,page,start_time,end_time,login_type);
    function start(app_key,page_size,page,start_time,end_time,login_type) {
        $.ajax({
            type:"post",
            url: url+"/login/count?access_token="+access_token,
            data:{
                "app_key":app_key,
                "page_size":page_size,
                "page":page,
