<template>
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main">
      ...
      <!--折线图-->
      <el-dialog title="活跃度展示图" :visible.sync="Broken_line" center>
...
<script>
  import {backActivityList,backendOrgRegion,backendCategory,backendActivityEdit,backendActivityOrg} from '../../api/api';
  import echarts from 'echarts'
  export default{
    data(){
      return {
        Jurisdiction:false,//权限字段
        organizational:[],
        filters: {
          hard: '',
          data_hard:'',
