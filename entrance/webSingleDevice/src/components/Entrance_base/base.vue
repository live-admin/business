<template>
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main">
        <el-table :data="tableData3" v-loading="listLoading" style="width: 100%" border>
            <el-table-column label="组织架构" width="380">
              ...
              <el-table-column prop="area_name" label="项目名称" width="100">
              </el-table-column>
              <el-table-column prop="community_name" label="小区名称" width="100">
              </el-table-column>
            </el-table-column>
            <el-table-column label="资源管理系统数据">
              <el-table-column prop="always_num" label="总户数">
              </el-table-column>
              <el-table-column prop="civilian_num" label="住宅户数">
              </el-table-column>
              <el-table-column prop="commercial_num" label="商铺户数">
              </el-table-column>
              <el-table-column prop="households" label="已入住户数">
              </el-table-column>
            </el-table-column>
        ...
        <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
          <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
            <el-form-item label="总户数">
              <el-input v-model="editForm.always_num" auto-complete="off"></el-input>
            </el-form-item>
