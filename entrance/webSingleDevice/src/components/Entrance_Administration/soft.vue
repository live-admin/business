  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>硬入口</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          ...
          <el-form-item>
            <el-select v-model="filters.soft" clearable placeholder="请选择入口">
              <el-option
                v-for="item in options_soft"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
      ...
      <el-table :data="books" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
        ...
        <el-table-column prop="name" label="常住户数" ></el-table-column>
        <el-table-column prop="name" label="平均计算人次" ></el-table-column>
        <el-table-column prop="name" label="平均活跃度" ></el-table-column>
        <!--<el-table-column prop="author" label="作者" width="100" sortable></el-table-column>-->
        <el-table-column prop="publishAt" label="出版日期" width="150"></el-table-column>
