...
{
    if(strtolower($column->name)==='is_deleted')continue;
...
?>
    ...
    public function behaviors()
    {
        return array(
<?php foreach($columns as $column): ?>
			<?php if(strtolower($column->name)==='is_deleted'){ ?>
            <?php echo "\n\t\t\t'IsDeletedBehavior' => array('class' => 'common.components.behaviors.IsDeletedBehavior'),"; ?>
            <?php }elseif(strtolower($column->name)==='state'){ ?>
            <?php echo "\n\t\t\t'StateBehavior' => array('class' => 'common.components.behaviors.StateBehavior'),"; ?>
            <?php }elseif(strtolower($column->name)==='parent_id'){ ?>
            <?php echo "\n\t\t\t'ParentBehavior' => array('class' => 'common.components.behaviors.ParentBehavior'), "; ?>
            <?php }elseif(strtolower($column->name)==='username'){ ?>
            <?php echo "\n\t\t\t'UserBehavior' => array('class' => 'common.components.behaviors.UserBehavior'),"; ?>
            <?php }elseif(strtolower($column->name)==='create_time'){ ?>
