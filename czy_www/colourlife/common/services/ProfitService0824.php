...
class ProfitService extends BaseService {
    ...
    public function makeWithdrawUrl($sn, $type='app')
    {
        ...
        if ( !in_array($orderModel->status, array(Item::PROFIT_ORDER_SUCCESS, Item::PROFIT_ORDER_CONTINUOUS, Item::PROFIT_ORDER_REDEEM_DONE)) )
...
//            'linkOrdBalance' => 0,
     ...
     * @return bool
     */
    public function getPropertyFee($roomId, $uuid='')
    {
        $fees = OthersAdvanceFees::model()->getApiAdvancePayfee($roomId, 1, $uuid);
