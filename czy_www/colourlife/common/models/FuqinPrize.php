...
/**
 * This is the model class for table "fuqin_prize".
 *
 * The followings are the available columns in table 'fuqin_prize':
 * @property integer $id
 ...
 */
class FuqinPrize extends CActiveRecord
{
	/**
...
(1:3元优惠券；2：6元优惠券；3：8元优惠券；4：12元优惠券；5：谢谢惠顾)',
	 ...
	 * @return FuqinPrize the static model class
	 */
