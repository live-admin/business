 ...
 */
class SetableClsCommunityRelation extends CActiveRecord
{
    ...
    {
        return 'setable_cls_community_relation';
    }
    ...
    public function  updateSetableClsCommunityRelation($id, $communityList)
    {
        //删除所有的相关记录
