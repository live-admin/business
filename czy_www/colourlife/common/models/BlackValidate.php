 ...
 * 判断验证次数
 */
class BlackValidate extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
				array('valinum', 'required'),
				array('is_deleted, valinum ,create_time', 'numerical', 'integerOnly'=>true),
				array('address, valinum', 'length', 'max'=>20),
				...
				array('id, mobile, address, valinum, user_agent, is_deleted, create_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('valinum',$this->valinum,true);
