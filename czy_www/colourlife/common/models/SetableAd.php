 ...
 */
class SetableAd extends CActiveRecord
{
    ...
    public function rules()
    {
		...
		return array(
            array('small_loans_id, img, title, url, state, sort,  act, proto_android, proto_ios', 'required', 'on' => 'update,create'),
           // array('secret', 'safe', 'on' => 'update,create'),
            array('id, small_loans_id, img, title,state, sort, proto_android, proto_ios, act', 'safe', 'on' => 'search'),
   ...
   public function getCommunityTreeData()
    {
        ...
        return $branch->getRegionCommunityRelation($this->id, 'SetableAd', false);
    }
