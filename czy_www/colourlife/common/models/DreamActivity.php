...
/**
 * This is the model class for table "dream_activity".
 *
 ...
 */
class DreamActivity extends CActiveRecord
{
	
	public $modelName = '梦想大看台';
...
// 			array('name, description, start_date, end_date, create_username', 'required', 'on' => 'update'),
			...
			array('start_date,end_date', 'checkRepeat', 'on' => 'create,update'),
    ...
    {
        if(!$this->hasErrors()&&(strtotime($this->start_date)>strtotime($this->end_date)))
            $this->addError($attribute,"活动时间有错误！");
