 ...
 */
class CairedpacketBranchRelationStep2 extends CActiveRecord
{	

	public $activityName;
	public $updateRedpacket;
	public $name='红包第二步关系';
	public $modelName = '彩管家红包第二步';
	/**
	 * @return string the associated database table name
	 */
	public function tableName()
	{
		return 'cairedpacket_branch_relation_step2';
	}
	...
	public function rules()
	{
		...
		return array(
			array('cai_redpacket_id, branch_id, step1_id, is_locked', 'numerical', 'integerOnly'=>true),
            ...
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, cai_redpacket_id, branch_id, get_redpacket, old_redpacket, amount, frozen_sum, step1_id, is_locked, activityName', 'safe', 'on'=>'search'),

            array('id, cai_redpacket_id, branch_id, get_redpacket, old_redpacket, amount, frozen_sum, step1_id, is_locked, activityName', 'safe', 'on'=>'search_forBranch'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            ...
            'cai_redpacket' => array(self::BELONGS_TO, 'CaiRedpacketStep2', 'cai_redpacket_id'),
        );
	}
    ...
    {	
        ...
        if (!$this->hasErrors() && !empty($this->get_redpacket) && !empty($this->cai_redpacket)) {
        	...
        	$model = CairedpacketBranchRelation::model()->find('cai_redpacket_id='.$this->cai_redpacket->step1_id.' and branch_id='.$this->branch->parent_id);
        	if($model){		
	...
	public function saveAll($cai_redpacket_id, $branchIds = array(), $step1_id)
    {
        ...
        foreach ($branchIds as $key => $val) {
            ...
            $model->step1_id = intval($step1_id);
