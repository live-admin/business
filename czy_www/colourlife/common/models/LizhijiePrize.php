...
/**
 * This is the model class for table "lizhijie_prize".
 *
 * The followings are the available columns in table 'lizhijie_prize':
 * @property integer $id
 ...
 */
class LizhijiePrize extends CActiveRecord
{
	/**
...
(1:没中奖；)',
	 ...
	 * @return LizhijiePrize the static model class
	 */
