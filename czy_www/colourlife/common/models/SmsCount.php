 ...
 */
class SmsCount extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('mobile, code', 'required'),
			array('code, create_time', 'numerical', 'integerOnly'=>true),
			...
			array('id, mobile, code, create_time', 'safe', 'on'=>'search'),
		);
	}
