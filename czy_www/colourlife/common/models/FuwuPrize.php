...
/**
 * This is the model class for table "fuwu_prize".
 *
 * The followings are the available columns in table 'fuwu_prize':
 * @property integer $id
 ...
 */
class FuwuPrize extends CActiveRecord
{
	/**
...
(1:5元抵用券；2：3元抵用券；3：1元抵用券；4：谢谢惠顾)',
	 ...
	 * @return FuwuPrize the static model class
	 */
