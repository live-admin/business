 ...
 */
class SetableAdCommunityRelation extends CActiveRecord
{
    ...
    {
        return 'setable_ad_community_relation';
    }
    ...
    public function  updateSetableAdCommunityRelation($id, $communityList)
    {
        //删除所有的相关记录
