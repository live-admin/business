 ...
 */
class SatisfactionSurvey extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            //array('note', 'safe'),
            array('id, answers, note, create_time, customer_id, startTime, endTime', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search()
    {
		...
		if (empty($this->startTime) && empty($this->endTime)) {
		    ...
		    //时间搜
			$criteria->select = 'com.name as communityName,
								count(*) as Number';
