...
/**
 * This is the model class for table "siyue_prize".
 *
 * The followings are the available columns in table 'siyue_prize':
 * @property integer $id
 ...
 */
class SiyuePrize extends CActiveRecord
{
	/**
...
(1:没中奖；)',
	 ...
	 * @return SiyuePrize the static model class
	 */
