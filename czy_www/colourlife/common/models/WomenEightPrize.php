...
/**
 * This is the model class for table "women_eight_prize".
 *
 * The followings are the available columns in table 'women_eight_prize':
 * @property integer $id
 ...
 */
class WomenEightPrize extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'mobile' => '手机号',
			'prize_id' => ' 奖品ID
(1:5元抵用券；2：3元抵用券；3：1元抵用券；4：谢谢惠顾)',
			'prize_name' => '奖品名称',
			'create_time' => '添加时间',
		);
	}
	 ...
	 * @return WomenEightPrize the static model class
	 */
