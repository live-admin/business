...
/**
 * This is the model class for table "yuanxiao_prize".
 *
 * The followings are the available columns in table 'yuanxiao_prize':
 * @property integer $id
 ...
 */
class YuanxiaoPrize extends CActiveRecord
{
	/**
...
',
	 ...
	 * @return YuanxiaoPrize the static model class
	 */
