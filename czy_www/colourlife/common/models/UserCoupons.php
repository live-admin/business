...
class UserCoupons extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('you_hui_quan_id, is_use, num, create_time', 'numerical', 'integerOnly'=>true),
			array('mobile', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, mobile, you_hui_quan_id, is_use, num, create_time', 'safe', 'on'=>'search'),
		);
	}
