 ...
 */
class ThirdFeesAddr extends CActiveRecord
{
    /**
...
//            array('community_id, build', 'compare', 'compareValue' => '0', 'operator' => '>', 'message' => '你输入的数据不正确'),
            ...
            array('period', 'safe'),
            array('id, cId, room, community_id, type_id,build_id', 'safe', 'on' => 'search'),
        );
    }
