 ...
 */
class SetableSmallLoansCommunityRelation extends CActiveRecord
{
    ...
    {
        return 'setable_small_loans_community_relation';
    }
    ...
    public function  updateSetableSmallloansCommunityRelation($id, $communityList)
    {
        //删除所有的相关记录
