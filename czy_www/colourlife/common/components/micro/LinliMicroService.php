...
//			$this->apiServer = 'http://114.119.6.163:8090/';
            $this->apiServer = 'http://linli-czytest.colourlife.com/';
			$this->privilegeServer = 'http://rules.test.colourlife.com/';
		} else {
			$this->apiServer = 'http://linli.colourlife.com/';
...
//		return $this->accessToken;
     ...
     * @throws CHttpException
     */
    public function dispatchService2($interface = '', $postData = array())
    {
        $this->apiServer = 'http://zan.linli.colourlife.com/';
        $response = json_decode(
            HttpClient::getHttpResponsePOST(
                $this->getApiUrl($interface),
                $this->handleSpecialCharInPostField($postData)
