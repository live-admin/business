...
class ICEParentBehavior extends CActiveRecordBehavior
{
	/**
	 ...
	 * @param int $startId -1 表示直接从第一级开始取数据，否则从指定 ID 开始取数据
	 * @param bool $hasSelf 数据中是否包括自身
	 * @param array $compares 其他过滤条件
	 *
	 * @return array
	 * $data = array(
	 *  '1' => array(
