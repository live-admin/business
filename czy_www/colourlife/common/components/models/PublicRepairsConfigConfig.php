...
class PublicRepairsConfigConfig extends Config
{
    ...
    public function rules()
    {
        return array_merge(
            ...
            array(
                ...
                array(
                    'automaticSupervisoryPositions,notAssessmentToVisitTime,fourthSenderLeaderID,threeSenderLeaderID,secondSenderPosition,communityLeader',
                    'safe',
                    'on' => 'update'
                ),
