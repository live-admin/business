...
class YiinfiniteScroller extends CBasePager {
    ...
    public $loadingImg = null;
    public $loadingText = null;
    public $donetext = null;
    ...
    public function init() {
        ...
        $this->_options['loading']['finishedMsg'] = $this->donetext;
        $this->_options['loading']['img'] = $this->loadingImg;
        $this->_options['loading']['msgText'] = $this->loadingText;
        parent::init();
    }
    ...
    public function registerClientScript() {
        $url = CHtml::asset(Yii::getPathOfAlias('comext.yiinfinite-scroll.assets').'/jquery.infinitescroll.min.js');
