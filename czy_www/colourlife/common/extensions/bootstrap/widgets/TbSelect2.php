...
class TbSelect2 extends CInputWidget
{
    ...
    protected $defaultOptions = array(
        'formatNoMatches' => 'js:function(){return "没有查询到您想要的结果";}',
        'formatInputTooShort' => 'js:function(input,min){var n = min - input.length; return "请输入字符不小于 " + n;}',
        'formatInputTooLong' => 'js:function(input,max){var n = input.length - max; return "请输入字符不大于 " + n;}',
        'formatSelectionTooBig' => 'js:function(limit){return "你只能够选择 " + limit + " 项";}',
        'formatLoadMore' => 'js:function(pageNumber){return "加载更多的结果...";}',
        'formatSearching' => 'js:function(){return "搜索中...";}',
    );
