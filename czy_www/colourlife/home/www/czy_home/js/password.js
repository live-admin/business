$(function(){
    ...
    function cookie(username){
        ...
        console.log(username,cookietime);
        console.log($.cookie('czy_username'));
        //if($.cookie('czy_username')!=""&&$.cookie('czy_username')!==null){
        //    $(".Customers>li:nth-child(2)").css("display",'block');
        //    $(".twoczy_username").html($.cookie('czy_username'));
    ...
    $(".Sign_out").click(function(){
        $(".Customers>li:nth-child(2)").css("display",'none');
        var cookietime = new Date();
        var timestamp=new Date().getTime();
        cookietime.setTime(timestamp + (60 * 60 * 1000));//coockie保存一小时
  ...
  //  }
   ...
   // });
    ...
    $(".Customers>li:nth-child(1)").click(function(){
    ...
    function sms_token(czy_phone,czy_yzm,two_czypassword){
        ...
        console.log(diff);
        console.log(tss);
        console.log(czy_phone,czy_yzm,two_czypassword);
        console.log("/1.0/sms?key="+key+"&ts="+tss+"&ve=1.0.0&secret="+secret+"");
    ...
    $(".navigation>li:last-child").click(function(){
    ...
    //var timestamp=new Date().getTime();
    //cookietime.setTime(timestamp + (60 * 60 * 1000));//coockie保存一小时
    //$.cookie("czy_username", "李建东",{expires:cookietime});
    //console.log($.cookie('czy_username'));
    //if($.cookie('czy_username')!=""&&$.cookie('czy_username')!==null){
