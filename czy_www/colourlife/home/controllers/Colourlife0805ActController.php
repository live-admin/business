<?php
class Colourlife0805ActController extends CController {
    
 //    private $startTime = '2015-07-16 00:00:00';       //活动开始时间
 //    private $endTime = '2015-07-30 23:59:59';           //活动结束时间
 ...
 //    // }
    ...
    //     $this->checkLogin();
    //     if(intval(date('H'))>=21||intval(date('H'))<9){
    //         echo CJSON::encode(1);
    //     }else{
