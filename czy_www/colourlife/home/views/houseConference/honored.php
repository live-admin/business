	...
	<body>
		<div class="conference">
            ...
            <div class="content_top">
               <p class="the_code"><input type="text" id="the_code" value="" placeholder="请输入领取码" /></p>
            ...
            <dl class="content_bottom">
               <dt>礼包说明</dt>
               <dd>
                 <span>1、</span><span>礼包为黑莓酒1元换购码，输入签到处工作人员发放的领取码即可领取。</span>
               </dd>
               <dd>
                 <span>2、</span><span>1元换购码：仅需支付1元即可换购价值168元的养生黑莓酒一份：500ml*2，换购有效期：6月30日当天。成功换购后，请于发布会现场提货。<a href="<?=$oneBuyHref?>&pid=1619">点击换购 &gt;&gt;</a> </span>
               </dd>
               <dd>
                 <span>3、</span><span>本礼包仅限6月30日出席彩生活住宅品牌发布会的嘉宾领取，彩生活拥有法律范围内的活动最终解释权。</span>
               </dd>
            </dl>
		</div>	
        <!--弹出框 start-->
        ...
        <div class="cd-popup alert3" role="alert">
            <div class="cd-popup-container">
                <p>您已获得养生黑莓酒1元换购特权<br />，市场价值168元/份。</p>
                <div class="cd-buttons">
                    <a href="<?=$oneBuyHref?>&pid=1619" class="close-pop">点击换购</a>
                </div>
                <a href="#" class="cd-popup-close"><img src="<?php echo F::getStaticsUrl('/home/houseConference/'); ?>images/close.png" class="lotteryimg img-replace" /></a>
