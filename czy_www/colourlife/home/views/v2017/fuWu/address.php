...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="<?php echo F::getStaticsUrl('/activity/v2017/fuWu/');?>js/CAAnimation.js"></script>
	    <script type="text/javascript" src="<?php echo F::getStaticsUrl('/activity/v2017/fuWu/');?>js/UIPickerView.js"></script>
	    <script type="text/javascript" src="<?php echo F::getStaticsUrl('/activity/v2017/fuWu/');?>js/editAddress.js"></script>
	    <link rel="stylesheet" href="<?php echo F::getStaticsUrl('/activity/v2017/fuWu/');?>css/style.css" />
	    <link rel="stylesheet" href="<?php echo F::getStaticsUrl('/activity/v2017/fuWu/');?>css/UIPickerView.css">
	...
	<body style="position: relative;">
		...
		<div class="conter conter_h">
			<div class="new_recipient">
				...
				<p><input type="text" placeholder="收件人" name="recipient" style="border: none;" class="add_one"></p>
				<div class="clear"></div>
			</div>
			<div class="new_phone">
				<p class="new_phone_img"></p>
				<p><input type="number" placeholder="联系电话" name="phone" style="border: none;" class="add_two"></p>
				<div class="clear"></div>
			</div>
			...
			<div class="new_address01">
				<p class="new_address_img"></p>
				<p><input type="text" placeholder="请输入详细地址" name="address01" style="border: none;" id="detail_add" class="add_three"></p>
				<div class="clear"></div>
			</div>
