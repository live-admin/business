...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="<?php echo F::getStaticsUrl('/activity/v2017/fuQin/');?>js/each.js"></script>
		...
		<div class="contaner">
			...
			<div class="contaner_rule">
				...
				<div class="contaner_p">
					<p>1.活动时间：2017年6月14日－2017年6月21日;</p>
