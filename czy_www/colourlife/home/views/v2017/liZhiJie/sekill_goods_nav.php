										...
										'<div class="rnk_right">'+
											...
											'<div class="num_box">'+
												'<div class="site_bot_box1a">'+
													...
													'<span class="span_left">'+'已抢'+nu+'件'+'</span><span><span >'+(Math.round(nu/obj[i].amount*10000)/100)+'</span>'+'%'+'</span>'+
													'<div class="clear"></div>'+
...
//						
			...
			function showTime(){
				...
				if (h<10) {
					...
					$(".drink").delegate("a","click",function(){
						$(".Pop_qiang").removeClass("hide");
						$(".mask").removeClass("hide");
						return false;
					});
					...
					$(".top_nav>ul>li:eq(0)>p:eq(1)").text("已结束");
