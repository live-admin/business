...
<script type="text/javascript" src="<?php echo F::getStaticsUrl("/");?>home/propertyfee/js/index.js"></script>
<script type="text/javascript">
var propertyFeesListUrl = "<?php echo $this->createUrl("PropertyFeesList")?>";
var advanceFeesListUrl = "<?php echo $this->createUrl("AdvanceFeesList")?>";
...
<body>
	<div id="header">
		<div class="button-panel"><button class="active btn-wuye"  data-tab-index="0">物业缴费</button>
		<button class="btn-wuye" data-tab-index="1" id="btnAdvanceFee">预缴费</button></div>
