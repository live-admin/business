...
<html>
    ...
    <div class="zongzi">
		<div class="head">
			<img src="<?php echo F::getStaticsUrl('/common/images/lucky/zongzi/head.jpg');?>" />
		</div>
		<div class="title">
			<span>活动战绩</span>
		</div>
         		...
         		<tbody>
         			<?php foreach ($list as $val){?>
						<tr>
							...
							<td><?php echo $val['isUse']==1?"已兑换":"<a href='".$url."&pid=5464' style=\"color:red;text-decoration:underline;\">去兑换</a>" ;?></td>
						</tr>
					<?php }?>	
				</tbody>
			</table>
		...
		<div class="rule">
			<ul>
				<li>活动规则：</li>
				<li>1、活动时间：2015年6月8日至2015年6月14日;</li>
				<li>2、每天10点、14点、16点、20点准时开抢;</li>
				<li>3、每次限量开抢，随机抢到;</li>
				...
				<li>5、粽子奖品统一在15日开始配送，预计7个工作日内由彩生活客户经理配送到家。</li>
			</ul>
		</div>
