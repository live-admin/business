...
<div class="hongbao" style="background:#fff8e4;">
  ...
  <div class="link4 clearfix">
    ...
    <a href="/luckyApp/inviteLucky?cust_id=<?php echo $cust_id;?>" class="floatright"><img src="<?php echo F::getStaticsUrl('/common/images/lucky/invite/img4.gif');?>" class="lotteryimg"  /></a>
  </div>
