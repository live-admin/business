...
<div class="main">
    ...
    <div class="invite">
        ...
        if($model->status==Visit::STATUS_UNTREATED)
        {
            ...
            <a href="/visit/accept/'.$model->id.'" class="green_btn floatL">接受</a>
            <a href="/visit/reject/'.$model->id.'" class="red_btn floatR">拒绝</a>
            </div>
        ...
        if($model->status==Visit::STATUS_NOCOMMENTS AND $model->is_complain!=1)
        {
            echo '
            <div class="btn_contairn_three">
            <a href="/visit/evaluation/'.$model->id.'" class="green_btn" style="width:100%;">评价</a>
            </div>
            ';
        }
    ...
    <div class="btn_contairn" style="margin:15px 0 50px;">
        <a href="/visit/history" class="dark_btn">返回</a>
    </div>
