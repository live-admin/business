...
.guangbi {
    background: none repeat scroll 0 0 #41a5dd;
    border-radius: 8px;
    color: #fff;
...
<body style="position:relative;"> 
	...
	<div class="alertcontairn_taikang2" style="padding-bottom:200px;">
     <div class="often_content">
       ...
       <div class="toubao">
         ...
         <a href="javascript:void(0);" class="confirm_btn">确认领取</a>
          <a href="/luckyApp" class="closeOpacity guangbi">返回</a>
       </div>
     </div>
     </div>
     ...
     <div class="alertcontairn alertcontairn_taikang3" style="display:none;">
       <div class="textinfo">
         <table>
           <tr>
             <td>
               <p>您的投保信息已经提交成功，泰康人寿将会</p>
               <p>在3个工作日内对投保信息进行审核处理；</p>
               <p>如果免费领取保险成功，泰康保险将会发送</p>
               <p>成功短信至投保人手机，并发送电子保单至</p>
               <p>投保人邮箱。</p>
               </p>
             </td>
           </tr>
       ...
       <div class="pop_btn">        
        ...
        <a href="/luckyApp/christmasResult">我的拆盒记录</a>
       </div>
     </div>
     <!--泰康人寿三 end-->
       ...
       <div class="often_content">
         ...
         <div class="rule_content">
           ...
           <ul>
             ...
             <li>5、投保前请详细阅读保险条款和重要申请（见刮奖结果页面> 查看【保险说明】），泰康人寿承担的保险
                 责任以所签发保单为准。
             </li>
