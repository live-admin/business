							...
							<div class="center_content">
                                ...
                                <p>位置：<span><?php echo F::ParamFilter($value['meter_address']); ?></span></p>
                                                    ...
                                                    <span
                                                        ...
                                                        <!--                    新增云控电表-->
                                                        <?php if($MeterBalance >= 1000 && $value['interface_type'] == 3){?>
                                                            <div class="right_img">
                                                                <span class="residue">剩余电量</span>
                                                                <img src="<?php echo F::getStaticsUrl('/home/yiNengYuan/images/img_02.png'); ?>"/>
                                                                <span class="residue_count"><?php echo $MeterBalance; ?>°</span></div>
                                                        <?php } ?>
                                                        <?php if($MeterBalance >= 100 && $MeterBalance < 1000 && $value['interface_type'] == 3){?>
                                                            <div class="right_img">
                                                                <span class="residue">剩余电量</span>
                                                                <img src="<?php echo F::getStaticsUrl('/home/yiNengYuan/images/img_03.png'); ?>"/>
                                                                <span class="residue_count"><?php echo $MeterBalance; ?>°</span></div>
                                                        <?php } ?>
                                                        <?php if($MeterBalance < 100  && $value['interface_type'] == 3){?>
                                                            <div class="right_img">
                                                                <span class="residue">剩余电量</span>
                                                                <img
