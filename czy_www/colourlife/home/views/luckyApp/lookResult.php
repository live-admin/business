...
<div class="lottery_topic">
   <div class="eight_mychoice">
     ...
     <dl class="lookresult">
       ...
       <dd>
        ...
        （<?php echo date("m月d日 H:i",strtotime($record->encounter->start_time)); ?>)</p>
         ...
         <?php if($record->encounter->outcome == 2){ ?>
                <h3><?php echo $record->encounter->GuestTeam; ?> &nbsp;
                 胜
                 &nbsp; <?php echo $record->encounter->HomeTeam; ?></h3>
         <?php }else{ ?>
         ...
         <?php if($record->myoutcome == 2){ ?>
              <p>您选择了<span> <?php echo $record->encounter->GuestTeam; ?>  
             <?php if($record->myoutcome == 2){ ?>胜<?php }else if($record->myoutcome == 1){ ?>负<?php }else if($record->myoutcome == 3){ ?>平<?php }else{ ?>VS<?php } ?>
               <?php echo $record->encounter->HomeTeam; ?></span>，
     ...
     <div class="changechoice"><a href="/luckyApp/guessOutcome" class="rulebtn">返回</a></div>
