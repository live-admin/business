   ...
   <div class=" tips_contairn" style="display:none;">
       <div class="alertcontairn_content">
         <div class="textinfo">
           ...
           <p><input type="text" class="moblie_number" id="moblie_number" style="margin-bottom:10px;" value="您的电信手机号码" defaultTxt="您的电信手机号码" /></p>
        ...
        <div class="alertcontairn_content">
           <div class="textinfo" style="text-align:left; color:#505050; border-style: none; padding-top:0;">
              <input type="hidden" id="fruitlucky_result_id" value=""/>  
                ...
                <p class="errortiptel" style="color:red; height:20px;"></p>
                <div class="line" style="border-color:#bca270"></div>
                <dl>
                    <dt>温馨提示：</dt>
  ...
  function mobileNumber(){
	      ...
	      $.post(
	          ...
	          function (data){
	               if(data == 1){
                    ...
                    $('.opacity>div').eq(0).hide();
                    $('.opacity>div').eq(1).show();
                }
	          }
	      ,'json');
	...
	function fruit_update(id){
        ...
        $.post(
            ...
            ,'json');
        $('.opacity').show();
        $('.opacity>div').eq(2).show();
        $('.opacity>div').eq(2).siblings().hide();
    }
