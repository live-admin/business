...
<body> 
   <div class="phone_contairn">
     <div class="rulepage">
       <div class="rule_head"><img src="<?php echo F::getStaticsUrl('/common/images/lucky/happiness/rule_top.jpg');?>" class="lotteryimg"/></div>       
       <div class="often_content">
         <div class="result_content">
          <p style="margin-top:30px; color:#fff; text-align:left; font-size:16px;">当前共有<span style="font-size:22px;"><?php echo $allJoin; ?></span>人参加此活动</p>
           <div class="tickerbox">
             <dl id="ticker">
