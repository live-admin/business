		...
		<div class="main">
			...
			<form action="" method="post" onsubmit="return false" id="suggestionForm">
                ...
                <p style="display: none;">
                    <input name="suggestion[category_id]" id="category_id" type="text" value="1" class="info_input" />
                </p>
			</div>
			<div style="color: red;" >
				<ul class="showRet">
	...
	$(document).ready(function(){
		$(".submit_button").click(function(){
			...
			if($("#content").val().length<10){
				$(".showRet").append("<li>您的建议不能少于10个字</li>");
				noError=false;
			}
			...
			if(noError){
				$.ajax({
					   ...
					   success: function(ret){
					     if(ret.success==1){
					    	 $(".showRet").append("<li>提交成功，谢谢您的反馈！</li>");
