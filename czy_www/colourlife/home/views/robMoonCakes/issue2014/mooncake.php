        ...
        <div class="mn_content_ct">
            ...
            <div class="mn_part">
                ...
                <p style="text-align:left;">
                    <span id="coloulife_refush2"><?php if($able == 1){ echo '本';}else{ echo '下'; }?>场剩余月饼</span>: <span class="nexttime" id="remaining"><?php if($able == 1){ echo $remaining;}else{ echo "300"; } ?></span> 份，<span class="nexttime" id="colourlife_span"><?php echo $timeRemainingNext?"下一场: ".date("d日H点",strtotime($timeRemainingNext))."准时开启":"活动已全部结束"; ?></span>
                </p>
