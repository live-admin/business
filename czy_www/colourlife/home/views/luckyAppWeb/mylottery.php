...
<div class="lottery_topic lottery_topic_webs" style="background:#fff;">
     ...
     <div class="lottery_content">
      ...
      <dl class="warmTip">
        <dt><span><img src="<?php echo F::getStaticsUrl('/common/images/lucky/may/loveHeart.png'); ?>" /></span><span>温馨提示: </span></dt>
              <dd>1、除5000元大奖外， 其他红包金额抽中立即发放到中奖人的红包帐户。</dd>
              <dd style="color:#ff7e00">2、5000元大奖领取说明：</dd>
              <dd style=" text-indent:48px;">
                  中奖后3个工作日内彩生活客户经理上门核实中奖人的中奖信息和中奖身份（必须是彩生活
                  业主或者是彩生活业主直系亲属）后，系统在一个工作日发放5000元红包到中奖人的红包帐号。
              </dd>
              <dd style="color:#ff7e00; text-indent:48px;">
    ...
    <div class="alertcontairn8" style="display:none;">
     ...
     <div class="alertcontairn9" style="display:none;">
       <div class="alertcontairn_content">
         ...
         <div class="pop_btn">
           <a href="javascript:myclose();"><span>返回</span></a>
         </div>
       </div>
     </div>
     <!--提示输入电信号码 end-->  
