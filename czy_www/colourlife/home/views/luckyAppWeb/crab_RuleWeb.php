       ...
       <div class="often_content">
         ...
         <div class="rule_content">
           ...
           <ul>
             ...
             <li>5、用户可以在"我的抽奖"页面查看中奖情况，开奖后由彩生活客服联系中奖人配送奖品。</li>
           ...
           <h3>本商家在售套餐推荐（购买请前往App首页>>"天天团"）</h3>
           <div class="crab_style_list clearfix">
             ...
             <ul class="crab_style_right">
               <li><a href="http://ckcyds.c.colourlife.com/goods/1299">
               ...
               <li>
                 ...
                 <span class="crab_s_normalprice">688型至尊礼盒(10只)</span>
               </li>
               <li>
                 <span class="crab_s_cheapprice">特惠价：448元</span>
                 <span class="crab_s_normalprice">888型至尊礼盒(10只)</span>
               </li>
               <li>
                 <span class="crab_s_cheapprice">特惠价：598元</span>
                 <span class="crab_s_normalprice">1198型至尊礼盒(10只)</span>
               </li>
             </ul>
           </div>
         </div>
         ...
         <div class="goback">
           <a href="/luckyAppWeb/robPerfectCrab">返回</a>
         </div>
       </div>
     </div>
