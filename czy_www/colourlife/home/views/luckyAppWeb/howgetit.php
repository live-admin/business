...
<div class="lottery_topic lottery_topic_webs" style="background:#fff;">
     ...
     <div class="lottery_content">
      <dl class="warmTip">
        <dt><span><img src="<?php echo F::getStaticsUrl('/common/images/lucky/may/rule2.png'); ?>" /></span><span>奖品领取说明 </span></dt>
        <dd>1.	奖品将在您中奖后15个工作日内， 由彩生活客户经理上门送到您手里。</dd>
        <dd>2.	彩生活享有法律范围内的活动最终解释权。</dd>
      </dl>
