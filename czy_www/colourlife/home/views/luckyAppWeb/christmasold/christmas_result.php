   ...
   <div class="phone_contairn web_contairn">
     <div class="rulepage">
       ...
       <div class="often_content">
           ...
           <div class="rule_content">
             ...
             <ul>
               ...
               <li>3、景点或酒店电子优惠劵，点击下面对应优惠商家查看奖品详情和使用说明：
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=huameida">&gt;&gt;&nbsp;深圳豪派特华美达酒店</a></p>
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=quyuan">&gt;&gt;&nbsp;深圳趣园私人酒店公寓</a></p>
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=shanjiaozhou">&gt;&gt;&nbsp;惠州巽寮湾海岛三角洲</a></p>
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=fengchidao">&gt;&gt;&nbsp;惠州巽寮湾湾凤池岛</a></p>
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=hao_ya">&gt;&gt;&nbsp;惠州巽寮湾皓雅养生度假酒店</a></p>
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=lizhi">&gt;&gt;&nbsp;惠州丽兹公馆</a></p>
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=luofushang">&gt;&gt;&nbsp;惠州罗浮山彩别院</a></p>
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=yi_jing">&gt;&gt;&nbsp;阳江颐景花园彩悦皓雅度假公寓</a></p>
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=tai_hu">&gt;&gt;&nbsp;苏州太湖天城酒店公寓</a></p>
                   <p><a target="_blank" href="<?php echo F::getFrontendUrl();?>luckyAppWeb/view?tpl=qing_feng">&gt;&gt;&nbsp;江西婺源清风仙境</a></p>
               </li>
               <li>4、5000元大奖领取说明：
         ...
         <div class="goback">
           <a href="<?php echo F::getFrontendUrl();?>luckyAppWeb">返回</a>
         </div>
       </div>
     </div>
