...
<body style="position:relative;"> 
   <div class="web_crab">
      <div class="web_shake_content">
        ...
        <div class="c_rule">
          <div><img src="<?php echo F::getStaticsUrl('/common/images/lucky/september/web_c_rule2.jpg');?>"/></div>  
          <div class="rule_content">
           <dl>
            <a name="crabrules"></a>
             <dt>活动规则：</dt>
             <dd>1、活动时间：10月10日至10月18日，一天一场次(每天0点开始，23: 59分结束)</dd>
           ...
           <h3>活动奖品由阿秀嫂蟹业商家提供：</h3>
           <div class="crabimg"><img src="<?php echo F::getStaticsUrl('/common/images/lucky/september/crab_rule11.jpg');?>" class="lotteryimg"/></div>
           <div class="crabimg"><img src="<?php echo F::getStaticsUrl('/common/images/lucky/september/crab_rule12.jpg');?>" class="lotteryimg"/></div>
           <div class="crabimg"><img src="<?php echo F::getStaticsUrl('/common/images/lucky/september/crab_rule13.jpg');?>" class="lotteryimg"/></div>
           <div class="crabimg"><img src="<?php echo F::getStaticsUrl('/common/images/lucky/september/crab_rule14.jpg');?>" class="lotteryimg"/></div>
           <h3>3种提货方式， 24小时顺丰闪电发货：</h3>
           <ul>
             <li>1、手机扫描礼劵二维码提货</li>
             <li>2、网上提货：http://axsxy.2wbuy.cn</li>
             <li>3、客服热线：0512-65448685</li>
           </ul>
           <h3>本商家在售套餐推荐</h3>
           <div class="crab_style_list clearfix">
             <div class="crab_style_left"><img src="<?php echo F::getStaticsUrl('/common/images/lucky/september/img5.jpg');?>" class="lotteryimg"/></div>
             <ul class="crab_style_right">
               <li><a href="http://<?php echo $domain;?>.c.colourlife.com/goods/1291">
                 <span class="crab_s_cheapprice">特惠价：258元</span>
                 <span class="crab_s_normalprice">798型礼券(10只)</span></a>
               </li>
               <li><a href="http://<?php echo $domain;?>.c.colourlife.com/goods/1293">
                 <span class="crab_s_cheapprice">特惠价：288元</span>
                 <span class="crab_s_normalprice">888型礼券(8只)</span></a>
               </li>
               <li><a href="http://<?php echo $domain;?>.c.colourlife.com/goods/1292">
                 <span class="crab_s_cheapprice">特惠价：418元</span>
                 <span class="crab_s_normalprice">1288型礼券(8只)</span></a>
               </li>
               <li><a href="http://<?php echo $domain;?>.c.colourlife.com/goods/1294">
                  <span class="crab_s_cheapprice">特惠价：628元</span>
                 <span class="crab_s_normalprice">1880型礼券(8只)</span></a>
               </li>
             </ul>
           </div>
         </div>
