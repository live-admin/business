...
<body style="position:relative;"> 
   <div class="web_crab">
      <div class="web_shake_content">
        ...
        <div class="c_rule">
          <div><img src="<?php echo F::getStaticsUrl('/common/images/lucky/september/web_c_rule1.jpg');?>"/></div>  
          <div class="rule_content">
           ...
           <div class="crab_style_list clearfix">
             <div class="crab_style_left"><img src="<?php echo F::getStaticsUrl('/common/images/lucky/september/img3.jpg');?>" class="lotteryimg"/></div>
             <ul class="crab_style_right">
               <li><a href="http://<?php echo $domain;?>.c.colourlife.com/goods/1295">
                 <span class="crab_s_cheapprice">特惠价：178元</span>
                 <span class="crab_s_normalprice">398型礼卡(6只)</span></a>
               </li>
               <li><a href="http://<?php echo $domain;?>.c.colourlife.com/goods/1296">
                 <span class="crab_s_cheapprice">特惠价：228元</span>
                 <span class="crab_s_normalprice">498型礼卡(8只)</span></a>
               </li>
               <li><a href="http://<?php echo $domain;?>.c.colourlife.com/goods/1297">
                 <span class="crab_s_cheapprice">特惠价：278元</span>
                 <span class="crab_s_normalprice">599型礼卡(8只)</span></a>
               </li>
               <li><a href="http://<?php echo $domain;?>.c.colourlife.com/goods/1298">
                 <span class="crab_s_cheapprice">特惠价：348元</span>
                 <span class="crab_s_normalprice">699型礼卡(10只)</span></a>
               </li>
             </ul>
           </div>
         </div>
