...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="<?php echo F::getStaticsUrl('/activity/v2016/caiZhuZhai/');?>js/index.js"></script>
	...
	<body>
		<div class="contaner">
			<div class="contaner_bg">
				...
				<img src="<?php echo F::getStaticsUrl('/activity/v2016/caiZhuZhai/');?>images/bg1.jpg"/>
		...
		<div class="pop hide">
			...
			<div class="lq_btn">
				<a href="/CaiZhuZhaiActivity/Receive">领取</a>
			</div>
		</div>
