...
<head>
    ...
    <link href="<?php echo F::getStaticsUrl('/common/css/e_finance.css'); ?>" rel="stylesheet">
    <link href="<?php echo F::getStaticsUrl('/common/css/commonNew.css'); ?>" rel="stylesheet">
    <link href="<?php echo F::getStaticsUrl('/common/css/baseNew.css'); ?>" rel="stylesheet">
    ...
    <style>
        ...
        * {margin:0;padding:0;}
        ...
        .xieyiphone dl dd{ text-indent:24px; line-height:200%;}
        .xieyiphone li,.xieyi p{ line-height:200%;}
        #table{ border:1px #999999 solid !important;}
        #table tr td{ border:1px #999999 solid !important;}
...
<div class="s_ifs_ix main el_container">
	<div class="phone_contairn">
	    <div class="xieyiphone" style="padding-bottom:50px; font-size:12px;">
	        <h3>彩富人生服务协议 </h3>
	        <ul>
	            <li>甲方：深圳市彩生活网络服务有限公司</li>
	            <li>地址：深圳市龙华新区民治街道留仙大道彩生活大厦</li>
	            <li>邮编：518000</li>
	        </ul>
	        <ul>
	            <li>乙方：深圳市彩付宝网络技术有限公司</li>
	            <li>地址：深圳市福田区保税区内市花路与紫荆路的交汇处花样年福年广场B5栋3楼</li>
	            <li>邮编：518000</li>
	        </ul>
	        <ul>
	            <li>丙方：</li>
	        ...
	        <ul>
	            <li>甲、乙、丙三方统称为"各方"，单称为"一方"。本协议签订于深圳市福田区。</li>
	        </ul>
	        <p>鉴于：</p>
	        ...
	        <dl>
	            <dd>
	                <table width="100%"  cellpadding="0" cellspacing="0" id="table">
	                    <tr>
	                        <td>投资期限（基础投资和增值投资一致）</td>
	                        <td><?php echo $month; ?>个月</td>
	                    </tr>
	                    <tr>
	                        <td>投资起算日</td>
	                        <td></td>
	                    ...
	                    <tr>
	                        <td>锁定期</td>
	                        <td> <span style="text-decoration: underline;">&nbsp;2&nbsp;</span> 个月（自投资起算日开始计算）</td>
	                    </tr>
	                </table>
	            </dd>
	        </dl>
	        ...
	        <dl>
	            ...
	            <dd>
	              	3、  本协议生效后，丙方的基础投资款项和增值投资款项将根据钱生花平台的自动投标规则作为借款出借给钱生花平台上有需要的借款人，之后的回款返还至丙方在乙方平台注册的账户中。丙方同意并授权，其个人账户内的收益余额由乙方向第三方支付机构发出指令按月付至甲方指定的账户，余款按照钱生花平台的自动投标规则继续投资直至投资期限届满。
	            </dd>
	        </dl>
	        <dl>
	            <dt>四、本计划的退出</dt>
	            <dd>1、到期退出</dd>
	            <dd>投资期满后，乙方需协助丙方对已投资债权进行转让，并将转让所得退回至丙方在乙方平台注册的账户中，丙方可对退回账户内的基础投资金额和增值投资金额以及对应的预期年化收益率范围内的收益进行提现或继续参与投资活动，并同意收益余额由乙方向第三方支付机构发出指令付至甲方指定账户。在投资期满且收益余额付至甲方指定账户后，本协议终止。</dd>
	            <dd>2、提前退出</dd>
	            <dd>
	                （1）锁定期内丙方不得申请提前赎回，从锁定期结束后的第一日到投资到期日前三日，丙方可通过彩之云APP申请提前全额赎回，丙方可以且仅可提出一次提前赎回申请，且必须申请全额赎回，丙方的提前赎回申请一旦提出，则不可撤销。
	            </dd>
	            <dd>
	                （2）丙方的提前赎回申请经乙方确认后，乙方通过彩之云APP告知丙方的提前赎回申请受理成功，则丙方成功提前退出本计划。
	            </dd>
	            <dd>
	                （3）提前赎回费用：丙方申请提前赎回的，应向乙方支付提前赎回费用。提前赎回费用分为三部分：
	            </dd>
	            <dd>
	               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、基础投资部分的提前赎回费用，即基础投资按照本协议第一条的约定已产生的收益；
	            </dd>
	            <dd>
	                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、增值投资部分的提前赎回费用，按照增值投资金额2%的标准计算，如果超过增值投资按照本协议第一条的约定产生的收益，则该部分提前赎回费用以该收益为限；
	            </dd>
	            <dd>
	                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、提前赎回时需支付投资领取礼品的费用，金额以礼品的市场价格为准。
	            </dd>
	            <dd>
	                （4）丙方申请提前赎回后，乙方需协助丙方对已投资债权进行转让，并将转让所得退回至丙方在乙方平台注册的账户中。丙方同意并授权乙方从丙方在乙方平台注册的账户中扣减收益余额及提前赎回费用，所扣除的金额由乙方向第三方支付机构发出指令，分别付至甲方指定的账户、乙方指定账户。丙方个人账户中的剩余款项可由丙方进行提现或继续参与投资活动。在丙方申请赎回且收益余额、提前赎回费用分别付至甲方指定账户、乙方指定账户后，本协议终止。
	            </dd>
	            <dd>
	                3、本协议终止后，丙方须按时自行向甲方或甲方关联公司交纳特定物业的管理费。
	            </dd>
	        </dl>
	        <dl>
	            <dt>五、本计划保障措施</dt>
	            <dd>
	                本计划由深圳市合和年投资咨询有限公司依据钱生花平台的相关规则提供有关保障服务。
	            </dd>
	        ...
	        <dl>
	            ...
	            <dt>（一）甲方的权利和义务</dt>
	            <dd>
	                1、甲方提供现场、非现场投资指引工作安排；
	            </dd>
	            <dd>
	                2、参与活动的订单在彩之云APP平台上生成，并由丙方进行确认；
	            </dd>
	            <dd>
	            ...
	            <dt>（二）	乙方的权利和义务</dt>
	            <dd>
	                1、乙方负责通过钱生花平台为甲、丙双方实现本计划；
	            </dd>
	            <dd>
	                2、乙方应对甲方和丙方的信息及本协议内容保密，但如甲方或丙方任何一方违约，或因相关权力部门要求（包括但不限于法院、仲裁机构、金融监管机构等），乙方有权进行披露。
	            </dd>
	            <dt>（三）丙方权利和义务</dt>
	            <dd>
	            ...
	            <dd>
	                2、丙方保证为履行本协议而向甲方和乙方提供的全部资料及信息均真实、有效，无虚假及误导性陈述。
	            </dd>
	            <dd>
	        ...
	        <dl>
	            <dt>七、特别备注：</dt>
	            <dd>
	                1、本协议采用电子文本形式制成，并永久保存在乙方为此设立的专用服务器上备查，各方均认可该形式的协议效力。
	            </dd>
	            <!--<dd>
	                2、本协议自文本最终生成之日生效。
	            </dd>-->
	            <dd>
	                2、本协议签订之日，若丙方的下列信息发生变更，其应当在相关信息发生变更三日内将更新后的信息提供给甲方：本人、本人的家庭联系人及紧急联系人、工作单位、居住地址、住所电话、手机号码、电子邮箱、银行账户的变更。若因任何一方不及时提供上述变更信息而带来的损失或额外费用应由该方承担。
	            </dd>
	            <dd>
	                3、如果本协议中的任何一条或多条违反适用的法律法规，则该条将被视为无效，但该无效条款并不影响本协议其他条款的效力。
	            </dd>
	            <dd>
	                4、由于地震、火灾、战争等不可抗力导致的交易中断、延误的，甲乙丙三方互不承担责任。但应在条件允许的情况下，应采取一切必要的补救措施以减小不可抗力造成的损失。
	            </dd>
	            <dd>
	                5、本协议项下产生的纠纷，各方先行协商解决，协商不成的，可向本协议签订地有管辖权的人民法院提起诉讼。 
	            </dd>
	        </dl>
	    </div>
