	...
	<div class="phone_contairn">
	    <div class="xieyiphone" style="padding-bottom:50px; font-size:12px;">
	        ...
	        <ul>
	            ...
	            <li>地址：深圳市南山区高新科技园大冲商务中心C栋701室</li>
	            <li>邮编：518000</li>
	        </ul>
	        <ul>
	            <li>丙方：</li>
			...
			<p>
				<b>
				&nbsp;&nbsp;&nbsp;&nbsp;注：丙方在加入本理财计划时，为完全民事行为能力人，能够自主识别本次投资行为所存在的风险及收益，且本次投资为丙方的真实意愿表示。
				</b>
			</p>
	        <dl>
	            <dt>一、本计划概述</dt>
	        ...
	        <dl>
	            <dd style="position:relative;top:0;left:0;">
	                <table width="100%"  cellpadding="0" cellspacing="0" id="table">
	                    ...
	                    <tr>
	                        <td>现金收益：基础投资预期年化收益率</td>
	                        <td></td>
	                    </tr>
						<tr>
							<td>饭票奖励：基础投资预期年化奖励比例</td>
							<td></td>
						</tr>
	                    <tr>
	                        <td>基础投资金额</td>
	                    ...
	                    <tr>
	                        <td>现金收益：增值投资预期年化收益率</td>
	                        <td></td>
	                    </tr>
						<tr>
							<td>饭票奖励：增值投资预期年化奖励比例</td>
							<td></td>
						</tr>
	                    <tr>
	                        <td>增值投资金额</td>
	                ...
	                <img src="<?php echo F::getStaticsUrl('/xieyi/');?>img/watermark.png" style="width:99%;position: absolute;left:4%;top:35%;transform: rotate(32deg);"/>
	            </dd>
	        </dl>
	        <dl>
	            <dd>
	        ...
	        <dl>
				...
				<dd>
					3、饭票奖励是指：丙方同意，若丙方通过本计划所产生的实际收益能达到预期年化奖励比例的，则丙方委托乙方将该部分收益转化为等额“彩之云饭票”，并委托甲方将“彩之云饭票”作为活动奖励，直接发放到丙方在彩之云APP上所注册的账号里。
				</dd>
	            <dd>
	              	4、  本协议生效后，丙方的基础投资款项和增值投资款项将根据钱生花平台的自动投标规则作为借款出借给钱生花平台上有需要的借款人，之后的回款返还至丙方在乙方平台注册的账户中。丙方同意并授权，其个人账户内的收益余额由乙方向第三方支付机构发出指令按月付至甲方指定的账户，余款按照钱生花平台的自动投标规则继续投资直至投资期限届满。
	            </dd>
	        </dl>
	        <dl>
	            <dt>四、本计划的退出</dt>
				...
				<dd>
					（3）如丙方提前赎回物业宝冲抵往期欠费的投资订单，乙方有权驳回该提前赎回申请。
				</dd>
	            <dd>
	                （4）提前赎回费用：丙方申请提前赎回的，应向乙方支付提前赎回费用。提前赎回费用分为两部分：
	            </dd>
	            <dd>
	            ...
	            <dd>
	                （5）丙方申请提前赎回后，乙方需协助丙方对已投资债权进行转让，并将转让所得退回至丙方在乙方平台注册的账户中。丙方同意并授权乙方从丙方在乙方平台注册的账户中扣减收益余额及提前赎回费用，所扣除的金额由乙方向第三方支付机构发出指令，分别付至甲方指定的账户、乙方指定账户。丙方个人账户中的剩余款项可由丙方进行提现或继续参与投资活动。在丙方申请赎回且收益余额、提前赎回费用分别付至甲方指定账户、乙方指定账户后，本协议终止。
	            </dd>
	            <dd>
	        ...
	        <dl>
	            ...
	            <dd>
	                6、本协议项下产生的纠纷，各方先行协商解决，协商不成的，可向本协议签订地有管辖权的人民法院提起诉讼。
	            </dd>
	        </dl>
	    </div>
