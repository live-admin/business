     ...
     <div class="rulepage">
       ...
       <div class="often_content">
         ...
         <div class="rule_content">
           <h3>奖品领取说明：</h3>
           <ul>
             <li>奖品内容: 彩生活定制黑莓酒一盒，500ml*2。</li>
             <li>奖品配送：因黑莓酒对运输的要求较高，奖品将统一在活动结束(1月31日)后７个工作日内由客户经理配送到中奖人家里。</li>
           </ul>
         </div>
         <div class="goback">
           <a href="<?php echo F::getFrontendUrl(F::getCommunityDomain(),'/luckyAppWeb/view?tpl=wine');?>">返回</a>
         </div>
       </div>
     </div>
