            ...
            <li class="clearfix">
                ...
                <div class="center_content">
                    ...
                    <p>位置：<span><?php echo Yii::app()->request->getParam('meter_address'); ?></span></p>
                                                        ...
                                                        <span
                                                            onclick="location='buy_recharge?cust_id=<?php echo Yii::app()->request->getParam('cust_id'); ?>&meter=<?php echo Yii::app()->request->getParam('meter'); ?>&customer_name=<?php echo Yii::app()->request->getParam('customer_name'); ?>&meter_address=<?php echo Yii::app()->request->getParam('meter_address'); ?>&status=<?php echo $status; ?>&MeterBalance=<?php echo $MeterBalance; ?>&interface_type=<?php echo $interface_type;  ?>'">
                                                            ...
                                                            <?php if ($MeterBalance >= 100 && $MeterBalance < 1000 && $interface_type == 2) { ?>
                                                                <div class="right_img">
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        °</span></div>
                                                            <?php } ?>
                                                            <?php if ($MeterBalance < 100 && $interface_type == 2) { ?>
                                                                <div class="right_img">
                                                                    <span class="residue">剩余电量</span>
                                                                    <img
                    ...
                    <li class="clearfix" onclick="href('<?php echo $value['sn']; ?>'); ">
                        ...
                        <div class="left_img_record">
                            <?php if ($value['status'] == "待付款") { ?>
                                <img
                                    src="<?php echo F::getStaticsUrl('/home/yiNengYuan/images/iconfont-daifukuan.png'); ?>"/>
                            <?php } ?>

                            <?php if ($value['status'] == "已付款") { ?>
                                <img
                                    src="<?php echo F::getStaticsUrl('/home/yiNengYuan/images/iconfont-yifukuan.png'); ?>"/>
                            <?php } ?>

                            <?php if ($value['status'] == "交易成功") { ?>
                                <img
                                    src="<?php echo F::getStaticsUrl('/home/yiNengYuan/images/iconfont-chenggong.png'); ?>"/>
                            <?php } ?>
...
<div class="pop_up" style="display:none;">
    <div class="iphone_pop dlt">
        ...
        <div class="dels_btn">
            ...
            <div class="comfirm_b" onclick="delete_power(<?php echo Yii::app()->request->getParam('id'); ?>,true)">确定
            </div>
...
<script type="text/javascript">
    ...
    function delete_power(id, confirm) {
