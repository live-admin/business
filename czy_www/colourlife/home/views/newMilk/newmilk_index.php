  ...
  <body>
    <div class="eLoan">
            ...
            <div class="indexcontent">
              <a  href="javascript:void(0);" class="apply" id="luck_tip"><img src="<?php echo F::getStaticsUrl('/common/images/lucky/october/milk/buy.jpg');?>" class="boximg" /></a>
              <p style="font-size:14px; text-align:right;"><a href="/newMilk/mylottery" style="color:#fff; text-decoration:underline; margin-right:10%;">我的抢购纪录</a></p>
              <dl>
                <dt>购买说明：</dt>
                <dd>1、第一波3月19日上午11点开始，限量200支，抢完即止；第二波3月19日下午3点开始，限量300支，抢完即止。</dd>
                <dd>2、本次抢购仅开放给彩科彩悦用户，每个用户限制抢购一支。</dd>
                <dd>3、抢购结束后，2个工作日内由彩生活客户经理配送到位。</dd>
