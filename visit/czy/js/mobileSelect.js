...
window.MobileSelect = (function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			_this.typeVal = document.querySelector(config.typeVal); //存放类型
			...
			var tempValue ='';
		    	...
		    	// document.getElementsByClassName('.type_val')[0].innerHTML = tempValue;
		    	_this.typeVal.innerHTML = tempValue;
