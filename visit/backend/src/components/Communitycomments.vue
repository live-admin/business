<template>
  <el-row class="warp" v-loading="loading" v-if="$route.name == '小区业主评价记录'">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/' }"><b>首页</b></el-breadcrumb-item>
        <el-breadcrumb-item>小区业主评价记录</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main">
      <el-form ref="form" :model="form" label-width="150px">
        ...
        <el-form-item label="评价等级">
          <el-select v-model="form.level_type" placeholder="请选择绑定状态">
        ...
        <el-form-item label="客户经理姓名">
          <el-input v-model="form.manager_name" placeholder="请选择输入客户经理姓名"></el-input>
        </el-form-item>
        <el-form-item label="客户经理手机号码">
          <el-input v-model="form.manager_mobile" placeholder="请选择彩之云账号"></el-input>
        </el-form-item>
        ...
        <el-form-item label="时间">
          <el-date-picker
            ...
            type="datetimerange"
            range-separator="至"
            start-placeholder="评论时间开始"
            end-placeholder="评论时间截止"
            @change="dataChange">
          </el-date-picker>
        </el-form-item>
        <el-form-item>
      ...
      <!-- <el-button @click="batchunbind" type="danger" plain  style="margin-top: 20px">批量解绑</el-button> -->
...
<script>
  import { commentList , org } from '../api/api';
  export default {
   data() {
      return {
        loading:true,
    ...
    methods:{
      ...
      initPage(){
        ...
        let param = {
            ...
            level_type:this.form.level_type,
            evaluate_type:this.form.evaluate_type,
      ...
      handleDetail(index,row){
        this.$router.push({path:'/viewdetail', query:{id:row.id , type:"3"} , name:"小区业主评价详情查看详情"});
      },
      ...
      exportDatas(){
        this.$router.push({path:'/backend/oa/export',query:{access_token:JSON.parse(window.sessionStorage.getItem('user')).access_token, oa_username:this.form.oa_username , user_id:this.form.user_id , bind_state:this.form.bind_state , time_start:this.form.times[0] , time_end:this.form.times[1] , org_uuid:this.form.org_uuid , name:this.form.name , mobile:this.form.mobile}});
      },
      handleClose(done) {
        this.dialogVisible = false;
      }
