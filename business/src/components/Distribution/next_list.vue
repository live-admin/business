    ...
    <div class="box_table">
      ...
      <el-dialog title="分账详情" :visible.sync="DetailedAccount" size="large">
        <el-table v-loading="loadDetailsing" :data="usersArray" border style="width:100%;float-size:0.8em;">
          ...
          <el-table-column prop="split_finance_pano" label="分配的金融平台货币账户" width="160">
          </el-table-column>
          <el-table-column prop="split_result" label="分账结果" width="180">
          </el-table-column>
          <el-table-column prop="create_at" label="创建时间" width="120">
          </el-table-column>
          <el-table-column prop="update_at" label="更新时间" width="120">
          </el-table-column>
          <el-table-column prop="orderno" label="订单号（内部记录）" width="180">
          </el-table-column>
          ...
          <el-table-column prop="general_uuid" label="商户类目uuid" width="180">
          </el-table-column>
  ...
  SubjectSearch(){//科目搜索
    if(this.SubjectsID==''&&this.OrderNumbers==''){
      ...
      let SplitLogParams = {
        ...
        order_source_id:this.$route.query.order_source_id,
